    ...
    <div id="title-container" class="sticky top-0 w-full flex items-center justify-between p-4 bg-mid-black z-20">
      ...
      <div id="buttons-container" class="flex items-center justify-center">
        <button v-if="selected.length"
          ...
          class="flex items-center justify-center bg-primary hover:bg-primary-dark transition-colors rounded w-full whitespace-nowrap p-2 mr-4"
        >
        ...
        <button class="flex items-center justify-center bg-low-white hover:bg-primary transition-colors rounded w-full whitespace-nowrap p-2 mr-4">
          <span class="text-full-white mr-2">
        ...
        <button
          @click="openNewDialog()"
          class="flex items-center justify-center bg-low-white hover:bg-primary transition-colors w-full rounded whitespace-nowrap p-2 mr-4"
        >
          <span class="text-full-white mr-2">
        ...
        <button class="flex items-center justify-center bg-low-white hover:bg-primary transition-colors w-full rounded whitespace-nowrap p-2">
          <span class="text-full-white mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <table class="block px-4 pr-0 bg-mid-black w-full overflow-scroll" style="height: 90% !important;">
        ...
        <tr>
          <th class="text-mid-white px-6 py-4 whitespace-nowrap rounded-l-2xl">
            <input id="header-checkbox"
              ...
              type="checkbox"
              value=""
              class="h-4 w-4 border border-gray-300 rounded-sm bg-low-white checked:bg-primary checked:border-primary focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
      ...
      <tbody class="z-10 w-full h-full">
        <tr v-for="(content, index) in tableContents" :key="index"
          class="hover:bg-full-black group"
        >
          ...
          <td class="px-6 py-4 whitespace-nowrap rounded-r-2xl w-full text-right sticky right-0 bg-mid-black group-hover:bg-full-black">
